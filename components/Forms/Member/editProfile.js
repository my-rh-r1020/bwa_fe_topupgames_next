...
export default function EditProfileForm({ form, handleChange, handleSubmit }) {
  return (
    <form action="">
      <div className="photo d-flex">
        <div className="position-relative me-20">
          <img src="/images/avatar-1.png" width="90" height="90" className="avatar img-fluid" />
      ...
      {/* Phone Number */}
      <TextInput label="Phone Number" type="tel" name="phone" placeholder="Enter your phone number" value={form.phoneNumber} onChange={handleChange} />

      <div className="button-group d-flex flex-column pt-40">
        <Button buttonName="Update My Profile" className="btn btn-save fw-medium text-lg text-white rounded-pill" action={handleSubmit} />
      </div>
    </form>
  );
}
