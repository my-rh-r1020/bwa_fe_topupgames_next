              ...
              {/* <div className="row">
                  ...
                  <div className="categories-card">
                    <div className="d-flex align-items-center mb-24">
                      <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="mask0-category-1" mask="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="60" height="60">
                          <circle cx="30" cy="30" r="30" fill="#D7D7F8" />
                        </mask>
                        <g mask="url(#mask0-category-1)">
                          <circle cx="30" cy="30" r="30" fill="#D7D7F8" />
                          <mask id="mask1-category-1" mask="alpha" maskUnits="userSpaceOnUse" x="10" y="12" width="40" height="30">
                ...
                <div className="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                  <div className="categories-card">
                    <div className="d-flex align-items-center mb-24">
                      <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="mask0-category-3" mask="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="60" height="60">
                          <circle cx="30" cy="30" r="30" fill="#D7D7F8" />
                        </mask>
                        <g mask="url(#mask0-category-3)">
                          <circle cx="30" cy="30" r="30" fill="#D7D7F8" />
                          <mask id="mask1-category-3" mask="alpha" maskUnits="userSpaceOnUse" x="10" y="12" width="40" height="30">
                            <rect x="10" y="12.5" width="40" height="28.75" rx="6" fill="#695DE9" />
                          </mask>
