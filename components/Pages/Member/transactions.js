...
import ListStatusItem from "../../Parts/Member/Transactions/statusItem";
          ...
          <div className="row mt-30 mb-20">
            <div className="col-lg-12 col-12 main-content">
              <div id="list_status_title">
                <Link href="#">
                  <a data-filter="*" className="btn btn-status rounded-pill text-sm btn-active me-3">
                    All Trx
                  </a>
                </Link>
                <Link href="#">
                  <a data-filter="success" className="btn btn-status rounded-pill text-sm me-3">
                    Success
                  </a>
                </Link>
                <Link href="#">
                  <a data-filter="pending" className="btn btn-status rounded-pill text-sm me-3">
                    Pending
                  </a>
                </Link>
                <Link href="#">
                  <a data-filter="failed" className="btn btn-status rounded-pill text-sm me-3">
                    Failed
                  </a>
                </Link>
              </div>
